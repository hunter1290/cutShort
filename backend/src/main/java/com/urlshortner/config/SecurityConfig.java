...
import com.urlshortner.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Public redirect — the core feature
                ...
                // AI code suggestions are informational only, same visibility as shortening
                .requestMatchers(HttpMethod.POST, "/api/urls/suggest-code").permitAll()
